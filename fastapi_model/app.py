...
@app.post("/model/point", tags=["data"], response_model=Point, status_code=201)
async def point(x: Annotated[int, Form()], y: Annotated[float, Form()]):
    return Point(x=x, y=y)

@app.post("/model/train", tags=["model"], status_code=201)
...
@app.post("/model/predict", tags=["model"], response_model=Point, status_code=201)
